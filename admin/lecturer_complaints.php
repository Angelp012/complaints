...
// Retrieve complaints for lecturer
$sql = "SELECT * FROM complaints WHERE name='lecturer' AND complaintno NOT IN (SELECT complaintno FROM resolutions)";
...
<head>
  ...
  <title>Lecturer Complaints</title>
  <style>
...
<body>
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='5' class='no-complaints'>No complaints found for lecturer.</td></tr>";
        }
        ?>
    </table>
</form>
