...
$sql = "SELECT * FROM complaints WHERE name='exams'AND complaintno NOT IN (SELECT complaintno FROM resolutions)";
...
<body>
 ...
 <table>
   ...
   if ($result->num_rows > 0) {
       ...
       echo "<tr><td colspan='5' class='no-complaints'>No complaints found for Exam.</td></tr>";
   }
?>
</table>
